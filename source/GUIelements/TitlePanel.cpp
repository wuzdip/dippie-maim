...
void TitlePanel::paint (juce::Graphics& g)
{
    ...
    auto stackedTitleFont = title_font.withHeight(32.f);
    g.setFont(stackedTitleFont);
    auto titleArea = textRect.withTrimmedRight(4).withTrimmedTop(4);
    auto lineHeight = (int) stackedTitleFont.getHeight();
    g.drawText ("DIPPIE", titleArea.withHeight(lineHeight),
        juce::Justification::centredTop, true);
    g.drawText ("MAIM", titleArea.withTrimmedTop(lineHeight).withHeight(lineHeight),
        juce::Justification::centredTop, true);
